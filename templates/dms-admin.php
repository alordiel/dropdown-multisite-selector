...
<div class="dms-admin">
	...
	<div class="dms-formular">
		...
		<form action="" id="dms-all-inputs">
			...
			<fieldset>
				...
				<input id="radio-none" type="radio" name="multisite" <?php if ( $multisite == 'none' || ! $multisite ) {
					echo 'checked="checked"';
				} ?> value="none"><?php _e( 'Disabled', 'dropdown-multisite-selector' ); ?><br>
				<input id="radio-all" type="radio" name="multisite" <?php if ( $multisite == 'all' ) {
					echo 'checked="checked"';
				} ?> value="all"><?php _e( 'Show all sites in the WMN.', 'dropdown-multisite-selector' ); ?><br>
				<input id="radio-users" type="radio" name="multisite" <?php if ( $multisite == 'usersonly' ) {
					echo 'checked="checked"';
				} ?>
				       value="usersonly"><?php _e( 'Show only the sites where the user is registered in the WMN. (works only for logged in users)', 'dropdown-multisite-selector' ); ?>
				<br>
			...
			<fieldset class="sorting-options-block" <?php if ( $multisite != 'none' ) {
				...
				<input id="sorting-none" type="radio"
				       name="sorting-option" <?php if ( $sorting == 'none' || ! $sorting ) {
					echo 'checked="checked"';
				} ?> value="none"><?php _e( 'Default', 'dropdown-multisite-selector' ); ?><br>
				<input id="sorting-alphabetic" type="radio"
				       name="sorting-option" <?php if ( $sorting == 'alphabetic' ) {
					echo 'checked="checked"';
				} ?> value="alphabetic"><?php _e( 'Alphabetic sorting', 'dropdown-multisite-selector' ); ?><br>
				<input id="sorting-last-be-first" type="radio"
				       name="sorting-option" <?php if ( $sorting == 'lastfirst' ) {
					echo 'checked="checked"';
				} ?>
				       value="lastfirst"><?php _e( 'Reverse the order (last entries will be the first options in the dropdown).', 'dropdown-multisite-selector' ); ?>
				<br>

			</fieldset>

			<fieldset class="middle-box" <?php if ( $multisite != 'none' ) {
				echo 'style="display:none"';
			} ?>>
			...
			<input type="submit" class="button button-primary button-large" value="<?php _e( 'Save', 'dropdown-multisite-selector' ); ?>" name="submit"
			       id="dms-submit">
	...
	<div class="dms-description">
		...
		<div> <?php _e( 'To add your own values in the shortcode use this one: </br><code>[dms_manual name="" placeholder="" target="" options=""]</code>', 'dropdown-multisite-selector' ); ?> </br>
